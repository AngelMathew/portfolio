    ...
    return(
        <div className={styles.contact} id="contact">
            ...
            <div className={styles.icons}>
                ...
                <a href="https://www.linkedin.com/in/angelannamathew" target="_blank" aria-label='link to https://www.linkedin.com/in/angelannamathew'>
           ...
           <button aria-label="Arrow" className={styles.scrollTopButton} onClick={()=>scrollToTop()}><img src={Arrow} alt="Up Arrow"></img></button>
